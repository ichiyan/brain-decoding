...
nsd_features = np.load('data/extracted_features/subj{:02d}/nsd_vdvae_depth_features_31l.npz'.format(sub))
...
np.save('data/predicted_features/subj{:02d}/nsd_vdvae_depth_nsdgeneral_pred_sub{}_31l_alpha50k.npy'.format(sub,sub),pred_latents)
...
with open('data/regression_weights/subj{:02d}/vdvae_regression_depth_weights.pkl'.format(sub),"wb") as f:
