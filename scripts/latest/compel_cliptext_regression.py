...
train_clip = np.load('data/extracted_features/subj{:02d}/nsd_compel_cliptext_train.npy'.format(sub))
test_clip = np.load('data/extracted_features/subj{:02d}/nsd_compel_cliptext_test.npy'.format(sub))
...
np.save('data/predicted_features/subj{:02d}/nsd_compel_cliptext_predtest_nsdgeneral.npy'.format(sub),pred_clip)
...
with open('data/regression_weights/subj{:02d}/compel_cliptext_regression_weights.pkl'.format(sub),"wb") as f:
