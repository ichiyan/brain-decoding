...
train_clip = np.load('data/extracted_features/subj{:02d}/nsd_compel_opencliptext_penultimate_train.npy'.format(sub))
test_clip = np.load('data/extracted_features/subj{:02d}/nsd_compel_opencliptext_penultimate_test.npy'.format(sub))
...
np.save('data/predicted_features/subj{:02d}/nsd_compel_sdxl_opencliptext_predtest_nsdgeneral.npy'.format(sub),pred_clip)
...
with open('data/regression_weights/subj{:02d}/compel_sdxl_opencliptext_regression_weights.pkl'.format(sub),"wb") as f:
