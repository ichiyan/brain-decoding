...
np.savez("data/extracted_features/subj{:02d}/nsd_vdvae_depth_features_{}l.npz".format(sub, num_latents),train_latents=train_latents,test_latents=test_latents)
