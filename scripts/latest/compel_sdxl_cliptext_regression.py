...
train_clip = np.load('data/extracted_features/subj{:02d}/nsd_compel_cliptext_penultimate_concat_train.npy'.format(sub))
test_clip = np.load('data/extracted_features/subj{:02d}/nsd_compel_cliptext_penultimate_concat_test.npy'.format(sub))
...
np.save('data/predicted_features/subj{:02d}/nsd_compel_sdxl_cliptext_predtest_nsdgeneral.npy'.format(sub),pred_clip)
...
with open('data/regression_weights/subj{:02d}/compel_sdxl_cliptext_regression_weights.pkl'.format(sub),"wb") as f:
