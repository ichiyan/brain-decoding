...
if sub in [1,2,5,7]:
    feats_dir = '/content/brain-decoding/data/eval_features/subj{:02d}'.format(sub)
    images_dir = '/content/drive/MyDrive/brain_decoding/data/reconstructed/sd_t2i/subj{:02d}'.format(sub)
